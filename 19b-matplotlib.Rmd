...
```{block2, type='rmdnote'}
Python 的 matplotlib 模块没有叫 `cairo_pdf` 的保存设备，所以此处设置为 `r dev = if(knitr::is_latex_output()) "pdf" else if(knitr::is_html_output()) "svg" else "png"`，它支持的图片格式有 eps, pdf, pgf, png, ps, raw, rgba, svg, svgz
```
