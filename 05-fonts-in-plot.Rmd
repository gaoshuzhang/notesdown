...
source("common.R")
Pkgs <- c(
  "maps", "mapdata", "mapproj", "xkcd", "extrafont", "fontcm"
)
...
这篇文章主要使用 ggplot2 包[@Wickham2016]绘图，为了好玩我们还使用 xkcd 字体，先下载和加载 xkcd 包[@R-xkcd]，它提供一个 gg 风格的图层`theme_xkcd()`，下载和注册 xkcd 字体
