...
```{r demo-ggplot2, fig.cap="showtext包处理图里的中文",fig.showtext=TRUE}
library(ggplot2)
...
```{r xkcd-embed,fig.cap = "xkcd 风的图", eval= knitr::is_latex_output()}
library(ggplot2)
library(extrafont)
library(xkcd)
...
```{r fontcm-demo, fig.width=8,fig.height=4,out.width="100%",fig.cap="fontcm 处理数学公式"}
library(fontcm)
p <- qplot(c(1, 5), c(1, 5)) +
