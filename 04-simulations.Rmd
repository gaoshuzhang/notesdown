...
```
```{r mesh-spde,fig.cap="基于INLA的三角网格划分", out.width="50%"}
knitr::include_graphics(path = "figures/mesh-spde.pdf")
```

REML 方法图\@ref(fig:spamm-sim)，INLA方法图 \@ref(fig:inla-simulation) ，低秩近似和 MCML 方法图 \@ref(fig:low-rank) 
