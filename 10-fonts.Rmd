...
```{r latex-tikz, engine='tikz', out.width='90%', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', fig.cap='tikz 图形', engine.opts = list(template = "tikz/tikz2pdf.tex"), eval = knitr::is_latex_output() & identical(Sys.getenv("TRAVIS"), "true")}
